...
@implementation MakeMoneyBottomView
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        UIView * topView = [self setUpViewWithTitle:@"起投金额" RightTitle:@"100元起投" RightColor:@"#1e78ff"];
        self.topView = topView;
        [self addSubview:topView];
        
        UIView * centerView = [self setUpViewWithTitle:@"债权转让" RightTitle:@"支持" RightColor:@"#1e78ff"];
        self.centerView = centerView;
        [self addSubview:centerView];
        
        UIView * BottomView = [self setUpViewWithTitle:@"项目详情" RightTitle:@">" RightColor:@"#666666"];
...
- (UIView *)setUpViewWithTitle:(NSString *)title RightTitle:(NSString *)rightTitle RightColor:(NSString *)rightColor{
    ...
    rightLabel.textColor = [UIColor colorWithHexString:rightColor];
